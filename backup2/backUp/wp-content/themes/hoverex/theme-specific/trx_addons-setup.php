...
//			$thumb_size = hoverex_get_thumb_size('big');
		return $thumb_size;
	}
}
...
if (!function_exists('hoverex_trx_addons_meta_box_fields')) {
	add_filter( 'trx_addons_filter_meta_box_fields', 'hoverex_trx_addons_meta_box_fields', 10, 2);
	function hoverex_trx_addons_meta_box_fields($mb, $post_type) {
