				...
				<thead>
					<tr>
						...
						<td class="hoverex_about_table_check"><?php
							...
							echo esc_html(sprintf(__('%s Free', 'hoverex'), $theme->name));
						?></td>
						<td class="hoverex_about_table_check"><?php
							// Translators: Show theme name with suffix 'PRO'
							echo esc_html(sprintf(__('%s PRO', 'hoverex'), $theme->name));
						?></td>
					</tr>
				</thead>
				<tbody>
					...
					<tr>
						<td class="hoverex_about_table_info">
							<h2 class="hoverex_about_table_info_title">
								<?php esc_html_e('Visual Composer', 'hoverex'); ?>
							</h2>
							<div class="hoverex_about_table_info_description"><?php
								esc_html_e('Full integration with a very popular page builder "Visual Composer". A number of useful shortcodes and widgets to create beautiful homepages and other sections of your website.', 'hoverex');
							?></div>
						</td>
						<td class="hoverex_about_table_check"><i class="dashicons dashicons-no"></i></td>
						<td class="hoverex_about_table_check"><i class="dashicons dashicons-yes"></i></td>
					...
					<tr>
						<td class="hoverex_about_table_info">
							...
							<div class="hoverex_about_table_info_description"><?php
								esc_html_e('A number of useful shortcodes to create beautiful homepages and other sections of your website with Visual Composer.', 'hoverex');
							?></div>
						</td>
						<td class="hoverex_about_table_check"><i class="dashicons dashicons-no"></i></td>
						<td class="hoverex_about_table_check"><i class="dashicons dashicons-yes"></i></td>
		...
		?><div class="hoverex_pro_form_wrap">
			<div class="hoverex_pro_form">
				...
				<h2 class="hoverex_pro_title"><?php
					...
					echo esc_html(sprintf(__('Upgrade %1$s Free v.%2$s to PRO', 'hoverex'),
											$theme->name,
											$theme->version
										)
								);
				...
				<div class="hoverex_pro_fields">
					<div class="hoverex_pro_field hoverex_pro_step1">
						<h3 class="hoverex_pro_step_title"><?php esc_html_e('Step 1', 'hoverex'); ?></h5>
					...
					<div class="hoverex_pro_field hoverex_pro_step2">
						<h3 class="hoverex_pro_step_title"><?php esc_html_e('Step 2', 'hoverex'); ?></h5>
...
if (!function_exists('hoverex_pro_get_pro_version_callback')) {
	...
	add_action('wp_ajax_nopriv_hoverex_get_pro_version',	'hoverex_pro_get_pro_version_callback');
...
if (!function_exists('hoverex_pro_upgrade_plugin')) {
	function hoverex_pro_upgrade_plugin($plugin_slug, $path) {
		...
		// Get plugin info
		$plugin_active = is_plugin_active($plugin_base);
