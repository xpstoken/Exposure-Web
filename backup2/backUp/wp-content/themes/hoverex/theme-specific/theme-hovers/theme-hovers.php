...
//					'slide_left'	=> esc_html__('Slide from Left',	'hoverex'),
//					'slide_right'	=> esc_html__('Slide from Right',	'hoverex'),
//					'slide_top'		=> esc_html__('Slide from Top',		'hoverex'),
//					'slide_bottom'	=> esc_html__('Slide from Bottom',	'hoverex'),
//					'arrow'			=> esc_html__('Arrow',				'hoverex'),
				),
				"type" => "select"
			),
			'image_hover' => array(
				...
				"options" => array(
					//'dots'	=> esc_html__('Dots',	'hoverex'),
					'icon'	=> esc_html__('Icon',	'hoverex'),
//					'icons'	=> esc_html__('Icons',	'hoverex'),
//					'zoom'	=> esc_html__('Zoom',	'hoverex'),
//					'fade'	=> esc_html__('Fade',	'hoverex'),
//					'slide'	=> esc_html__('Slide',	'hoverex'),
//					'pull'	=> esc_html__('Pull',	'hoverex'),
//					'border'=> esc_html__('Border',	'hoverex')
				),
				"type" => "select"
			) )
		);
