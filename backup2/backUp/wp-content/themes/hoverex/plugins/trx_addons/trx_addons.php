...
if (!function_exists('hoverex_trx_addons_theme_setup9')) {
	...
	function hoverex_trx_addons_theme_setup9() {
		if (hoverex_exists_trx_addons()) {
			...
			if (is_admin()) {
				add_filter( 'hoverex_filter_allow_meta_box', 			'hoverex_trx_addons_allow_meta_box', 10, 2);
...
if (!function_exists('hoverex_trx_addons_allow_meta_box')) {
	//Handler of the add_filter( 'hoverex_filter_allow_meta_box', 'hoverex_trx_addons_allow_meta_box', 10, 2);
	function hoverex_trx_addons_allow_meta_box($allow, $post_type) {
		return $allow
