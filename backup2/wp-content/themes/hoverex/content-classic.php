...
?><div class="<?php echo $hoverex_blog_style[0] == 'classic' ? 'column' : 'masonry_item masonry_item'; ?>-1_<?php echo esc_attr($hoverex_columns); ?>"><article id="post-<?php the_ID(); ?>" 
	...
	<div class="post_content entry-content">
		<div class="post_content_inner">
			<?php
			$hoverex_show_learn_more = false; //!in_array($hoverex_post_format, array('link', 'aside', 'status', 'quote'));
			if (has_excerpt()) {
				the_excerpt();
