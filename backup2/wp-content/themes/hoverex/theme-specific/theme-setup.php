	...
	'required_plugins' => array_merge(
		...
		//-----------------------------------------------------
			: array(
					...
					'js_composer'				=> esc_html__('Visual Composer', 'hoverex'),
					'vc-extensions-bundle'		=> esc_html__('Visual Composer extensions bundle', 'hoverex'),
					'give'		                => esc_html__('Give - Donation Plugin', 'hoverex'),
					)
	),
	
	// Key validator: market[env|loc]-vendor[axiom|ancora|themerex]
	'theme_pro_key'		=> HOVEREX_THEME_FREE 
								? 'env-themerex' 
								: '',

	// Theme-specific URLs (will be escaped in place of the output)
	'theme_demo_url'	=> 'http://hoverex.themerex.net',
	'theme_doc_url'		=> 'http://hoverex.themerex.net/doc',
	'theme_download_url'=> 'http://themeforest.net/user/themerex',
...
if ( !function_exists('hoverex_customizer_theme_setup1') ) {
	...
	function hoverex_customizer_theme_setup1() {
		...
		hoverex_storage_set('scheme_color_groups', array(
			'main'	=> array(
							'title'			=> __('Main', 'hoverex'),
							'description'	=> __('Colors of the main content area', 'hoverex')
							),
			'alter'	=> array(
							'title'			=> __('Alter', 'hoverex'),
							'description'	=> __('Colors of the alternative blocks (sidebars, etc.)', 'hoverex')
							),
			'extra'	=> array(
							'title'			=> __('Extra', 'hoverex'),
							'description'	=> __('Colors of the extra blocks (dropdowns, price blocks, table headers, etc.)', 'hoverex')
							),
			'inverse' => array(
							'title'			=> __('Inverse', 'hoverex'),
							'description'	=> __('Colors of the inverse blocks - when link color used as background of the block (dropdowns, blockquotes, etc.)', 'hoverex')
							),
			'input'	=> array(
							'title'			=> __('Input', 'hoverex'),
							'description'	=> __('Colors of the form fields (text field, textarea, select, etc.)', 'hoverex')
							),
			)
		);
		hoverex_storage_set('scheme_color_names', array(
			'bg_color'	=> array(
							'title'			=> __('Background color', 'hoverex'),
							'description'	=> __('Background color of this block in the normal state', 'hoverex')
							),
			'bg_hover'	=> array(
							'title'			=> __('Background hover', 'hoverex'),
							'description'	=> __('Background color of this block in the hovered state', 'hoverex')
							),
			'bd_color'	=> array(
							'title'			=> __('Border color', 'hoverex'),
							'description'	=> __('Border color of this block in the normal state', 'hoverex')
							),
			'bd_hover'	=>  array(
							'title'			=> __('Border hover', 'hoverex'),
							'description'	=> __('Border color of this block in the hovered state', 'hoverex')
							),
			'text'		=> array(
							'title'			=> __('Text', 'hoverex'),
							'description'	=> __('Color of the plain text inside this block', 'hoverex')
							),
			'text_dark'	=> array(
							'title'			=> __('Text dark', 'hoverex'),
							'description'	=> __('Color of the dark text (bold, header, etc.) inside this block', 'hoverex')
							),
			'text_light'=> array(
							'title'			=> __('Text light', 'hoverex'),
							'description'	=> __('Color of the light text (post meta, etc.) inside this block', 'hoverex')
							),
			'text_link'	=> array(
							'title'			=> __('Link', 'hoverex'),
							'description'	=> __('Color of the links inside this block', 'hoverex')
							),
			'text_hover'=> array(
							'title'			=> __('Link hover', 'hoverex'),
							'description'	=> __('Color of the hovered state of links inside this block', 'hoverex')
							),
			'text_link2'=> array(
							'title'			=> __('Link 2', 'hoverex'),
							'description'	=> __('Color of the accented texts (areas) inside this block', 'hoverex')
							),
			'text_hover2'=> array(
							'title'			=> __('Link 2 hover', 'hoverex'),
							'description'	=> __('Color of the hovered state of accented texts (areas) inside this block', 'hoverex')
							),
			'text_link3'=> array(
							'title'			=> __('Link 3', 'hoverex'),
							'description'	=> __('Color of the other accented texts (buttons) inside this block', 'hoverex')
							),
			'text_hover3'=> array(
							'title'			=> __('Link 3 hover', 'hoverex'),
							'description'	=> __('Color of the hovered state of other accented texts (buttons) inside this block', 'hoverex')
							)
			)
		);
...
if ( !function_exists( 'hoverex_importer_set_options' ) ) {
	...
	function hoverex_importer_set_options($options=array()) {
		if (is_array($options)) {
			...
			// 		$options['files']['dark_demo']['title'] = esc_html__('Dark Demo', 'hoverex');
			// Banners
			$options['banners'] = array(
				array(
					...
					'content' => wp_kses_post(__("Create your front page right in the WordPress Customizer. There's no need in Visual Composer, or any other builder. Simply enable/disable sections, fill them out with content, and customize to your liking.", 'hoverex')),
...
if (!function_exists('hoverex_create_theme_options')) {
	...
	function hoverex_create_theme_options() {
		...
		$msg_override = __('Attention! Some of these options can be overridden in the following sections (Blog, Plugins settings, etc.) or in the settings of individual pages', 'hoverex');
